...
#define LED1_ON()		LD1_PORT->BSRR |= LD1_PIN;//\
                        LD1_PORT->BSRR &= ~(LD1_PIN << 16U)
#define LED1_OFF()	    LD1_PORT->BRR |= LD1_PIN

#define LED2_ON()		LD2_PORT->BSRR |= LD2_PIN;//\
						LD2_PORT->BSRR &= ~(LD2_PIN << 16U)
#define LED2_OFF()	    LD2_PORT->BRR |= LD2_PIN

#define LED3_ON()		LD3_PORT->BSRR |= LD3_PIN;//\
						LD3_PORT->BSRR &= ~(LD3_PIN << 16U)
#define LED3_OFF()	    LD3_PORT->BRR |= LD3_PIN
...
#define LD1_PIN       IO_5
#define LD2_PIN       IO_14
#define LD3_PIN       IO_9

#define LD1_PORT      GPIOA
#define LD2_PORT      GPIOB
#define LD3_PORT      GPIOC

#define PB1           IO_13
#define WIFI_NSS      IO_0
